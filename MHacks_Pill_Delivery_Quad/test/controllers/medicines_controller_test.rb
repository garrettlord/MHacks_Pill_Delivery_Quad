...
class MedicinesControllerTest < ActionController::TestCase
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post :create, medicine: { description: @medicine.description, hospital_id: @medicine.hospital_id, name: @medicine.name, quantity: @medicine.quantity, restricted: @medicine.restricted, type: @medicine.type }
    end
  ...
  test "should update medicine" do
    patch :update, id: @medicine, medicine: { description: @medicine.description, hospital_id: @medicine.hospital_id, name: @medicine.name, quantity: @medicine.quantity, restricted: @medicine.restricted, type: @medicine.type }
    assert_redirected_to medicine_path(assigns(:medicine))
  end
