...
class DestinationsControllerTest < ActionController::TestCase
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post :create, destination: { description: @destination.description, hospital_id: @destination.hospital_id, latitude: @destination.latitude, longitude: @destination.longitude, name: @destination.name }
    end
  ...
  test "should update destination" do
    patch :update, id: @destination, destination: { description: @destination.description, hospital_id: @destination.hospital_id, latitude: @destination.latitude, longitude: @destination.longitude, name: @destination.name }
    assert_redirected_to destination_path(assigns(:destination))
  end
