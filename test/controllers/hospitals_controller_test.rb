...
class HospitalsControllerTest < ActionController::TestCase
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post :create, hospital: { latitude: @hospital.latitude, longitude: @hospital.longitude, name: @hospital.name }
    end
  ...
  test "should update hospital" do
    patch :update, id: @hospital, hospital: { latitude: @hospital.latitude, longitude: @hospital.longitude, name: @hospital.name }
    assert_redirected_to hospital_path(assigns(:hospital))
  end
